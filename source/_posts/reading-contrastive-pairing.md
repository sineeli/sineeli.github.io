---
title: "Reading: Contrastive Learning Pairing Strategies for Embedding Fine-Tuning"
date: 2026-09-19 01:00:00
categories: reading
tags:
    - Search
    - Vector Search
...
Notes from idealo's MICES 2026 talk *"Hybrid Search at idealo"* (Gennady Shabanov, Atakan Filgöz), specifically the part about how they built **positive/negative pairs** from click-through data to fine-tune a sentence embedding model with contrastive learning. This post is my own attempt to understand the underlying math well enough to reuse the idea, not just the slide bullet points.

<!-- more -->

**Source:** MICES 2026 slides — [Hybrid Search at idealo](https://mices.co/mices2026/slides/gennady-shabanov-atakan-filgoz-mices-2026.pdf)
...
Fine-tuning the embedding model only solves *half* the problem — you still need to combine its ranked list with the existing keyword (BM25/Lucene) ranked list. idealo compared two ways to do this.
